  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">历史归档</h1>
          <p className="text-gray-600">按日期浏览一周前的全部内容</p>
        </div>

        {archiveItems.length === 0 ? (
          <div className="text-center py-12">
            <Calendar className="w-12 h-12 text-gray-400 mx-auto mb-4" />
            <h3 className="text-lg font-medium text-gray-900 mb-2">暂无历史归档</h3>
            <p className="text-gray-500">当内容超过一周后会自动出现在此处</p>
          </div>
        ) : (
